...
echo  archivo: la llave de Firebase y los passwords quedan en
...
echo  del historial: hay que rotar la credencial. En Firebase:
echo  consola - Cuentas de servicio - generar llave nueva y
echo  borrar la vieja.
echo.
pause
exit /b 1
