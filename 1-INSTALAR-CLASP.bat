...
node --version > "%TEMP%\chk_node.txt" 2>nul
set "NODEV="
if exist "%TEMP%\chk_node.txt" set /p NODEV=<"%TEMP%\chk_node.txt"
del "%TEMP%\chk_node.txt" >nul 2>&1
echo          !NODEV!
echo.
...
echo.
echo          Se abrira tu navegador. Entra con
echo          victor.walmart.04: es la duena del Sheet y del
echo          Apps Script del checador.
echo.
pause
call clasp login
echo.
