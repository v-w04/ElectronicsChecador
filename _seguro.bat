...
REM  archivo: la llave de la cuenta de servicio de Firebase y
REM  los passwords viven en PropertiesService. Si algo salta
REM  aqui, es que alguien pego un valor real "solo para probar".
REM
